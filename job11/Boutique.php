...
class Clothing extends Product {
    ...
    public function __construct(int $id = null, string $name = '', array $photos = [], int $price = 0, string $description = '', int $quantity = 0, DateTime $createdAt = null, DateTime $updatedAt = null, int $categoryId = null,string $size, string $color, string $type, int $material_fee) {
        $this->size = $size;
        $this->color = $color;
        $this->type = $type;
